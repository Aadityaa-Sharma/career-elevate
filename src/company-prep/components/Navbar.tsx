...
import { BookOpen, Home, Users, Target, BarChart3, Menu, X } from 'lucide-react'
import { Button } from '@/company-prep/components/ui/button'
import ThemeToggle from '@/company-prep/components/ThemeToggle'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-3">
            <Link to="/" className="text-sm text-muted-foreground hover:text-foreground">← Back to Career Elevator</Link>
