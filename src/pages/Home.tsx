...
import { features, featuresConfig, moreTools, Feature, MoreTool } from '../data/features';
import {
  ArrowRight,
  X,
  ExternalLink,
...
function Home() {
  ...
  const handleRedirect = (type: string) => {
    ...
    const urls = {
      traditional: "/features/manual-scanner",
      ...
      <section className="relative overflow-hidden" style={{ width: '100%', height: '100dvh', position: 'relative' }}>
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-6 z-30">
          ...
          <p className="text-xl text-gray-400 mb-12 max-w-2xl leading-relaxed">
            Advanced AI-powered tools that analyze, optimize, and accelerate your professional journey through intelligent career development.
          </p>
      ...
      <section className="bg-white pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6">
          <div
            ...
            style={{
              background: 'linear-gradient(135deg,rgb(54, 53, 54) 0%, #1a1a1a 50%,rgb(21, 20, 20) 100%)'
            }}
          >
            ...
            <div className="relative text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Join thousands of professionals who have successfully advanced their careers with our AI-powered tools
              </p>
              <button
                onClick={() => setShowModal(true)}
                className="bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-50 transition-colors duration-300 shadow-lg hover:shadow-xl"
              >
                Get Started Today
              </button>
            </div>
